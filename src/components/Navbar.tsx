...
export default function Navbar() {
  ...
  <nav className="relative bg-white shadow-lg">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-around  items-center h-20 md:space-x-8">
        {/* Logo */}
            ...
            item.submenu ? (
              ...
              >
                ...
                {activeDropdown === item.name && (
                  <div className="absolute left-0 pt-2 w-64 bg-white border rounded border-gray-200 shadow-lg z-10">
